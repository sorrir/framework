...
export interface Configuration {
  readonly components: AtomicComponent<any, any>[];
...
export function createConnection<P_SOURCE, P_TARGET, EVENT_TYPE>(
  sourceComponent: AtomicComponent<any, P_SOURCE>,
  sourcePortName: P_SOURCE,
  targetComponent: AtomicComponent<any, P_TARGET>,
...
export function createStatemachineComponent<E, P, D>(
  ...
  name?: string,
  dependencyMap?: Map<D, DependencyFunction<any, E, P, D, any>>,
...
export function getPortFromName<EVENT_TYPE, PORT_TYPES>(
  component: AtomicComponent<EVENT_TYPE, PORT_TYPES>,
  name: PORT_TYPES
):
